...
class ProjectsController < ApplicationController
  ...
  def can_update_on_the_spot?
    project_fields = []
    project_admin_fields = ["name", "about", "headline", "can_finish", "expires_at", "user_id", "image_url", "video_url", "visible", "investment_scale", "rate", "rejected", "recommended", "home_page", "order"]
